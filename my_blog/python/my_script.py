...
file_str = f'export const MDFILE_LIST: string[] = {md_file_list}\n'
...
# file_str = f'export const filearr: string[] = {md_file_list}\n'

# file_list = os.listdir('./public/md2/')
# md_file_list = [file_name for file_name in file_list if file_name.endswith('.md')]

# file_str2 = f'export const filearr: string[] = {md_file_list}\n'
